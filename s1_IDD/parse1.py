...
parser.add_argument('--topks', nargs='?', default="[5,20]",
                        help="@k test list")
parser.add_argument('--dataset', type=str, default='peek',
                    help="available datasets: [yelp, ml100k, adressa, mooc, beauty, peek]")
...
log_file = f'./log/{args.dataset}_{args.model}_lr{args.lr}.txt'
