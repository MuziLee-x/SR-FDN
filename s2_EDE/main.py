...
def main():
    ...
    # parser.add_argument("--data_dir", default="./data/ml100k/", type=str)
    parser.add_argument("--data_dir", default="./data/yelp/", type=str)   # "/home/lili/DenoisedSeqRec/s2_EDE/data/yelp/"
    parser.add_argument("--output_dir", default="output/", type=str)
    # parser.add_argument("--data_name", default="peekClean", type=str)
    parser.add_argument("--data_name", default="yelpNoise", type=str)
    # parser.add_argument("--data_name", default="clean-ml-1m", type=str)
    # parser.add_argument("--data_name", default="noise-ml-1m", type=str)
    ...
    parser.add_argument("--max_seq_length", default=50, type=int)  # movielen:50
    # parser.add_argument("--max_seq_length", default=20, type=int)   # yelp:20
    ...
    parser.add_argument("--add_eps", default="True", type=str)
    ...
    print('max_item', max_item)  # max_item 12101, max_item 0???
    # print(seq_dic)  # {}
    ...
    args_str = f'{args.model_name}-{args.data_name}-{args.hidden_size}-{cur_time}'
