...
sequential_data_list = ['beautyNoise','beautyClean','yelpNoise', 'yelpClean','clean-ml-1m', 'noise-ml-1m', 'moocNoise', 'moocClean', 'peekNoise', 'peekClean']
...
def get_seq_dic(args):
    ...
    if args.data_name in sequential_data_list:
        ...
        # user_seq, max_item, num_users, sample_seq = \
            # get_user_seqs_and_sample("/home/lili/FMLP_try/data/clean-ml-1m.txt", "/home/lili/FMLP_try/data/clean-ml-1m_sample.txt")
